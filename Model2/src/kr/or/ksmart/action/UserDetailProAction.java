...
public class UserDetailProAction implements UserActionInterFace {

	@Override
	public UserActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("05_06_execute_UserDetailProAction.java");
		...
		//02단계 : UserDao 객체 내에 회원상세정보를 위한 조회 메서드 호출 
		UserDao userDao = new UserDao();
		UserDto userDto = userDao.userDetail(u_id);
		...
		userActionForward.setPath("/user_detail/user_detail_pro.jsp");
